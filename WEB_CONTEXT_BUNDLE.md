...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-d2cba888354f594c"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-d2cba888354f594c",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-d2cba888354f594c",
        "url": "https://en.wikipedia.org/wiki/Erd%C5%91s%E2%80%93Ulam_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Erdős–Ulam problem : Is there a dense set of points in the plane all at rational distances from one another?",
      "version": 1
    },
    "title": "Erdős–Ulam problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "571bf509b51540f372a1fbc8213e45b72a91720f876c98b3aa4839eaf2590628"
}
```
